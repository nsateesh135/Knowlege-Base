...
# Ask the player for there bet 
# Make sure players bet doen't exceed available chips 
# deal 2 cads to the dealer and 2 cards to the player 
# show only one of the dealers card
# show both of the players cards 
# ask the player if they want to hit and take another card 
# If the players card doesn't exceed 21 ask if they'll like to hit again 
# If a player stands, play delaers hand. The dealer will always hit until the Dealers value meets or exceeds 17 
# Determine the winner and adjust the players chips accordingly 
